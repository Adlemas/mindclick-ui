...
<main>
  <div class="container">
    <div class="row mb-4">
      <div class="col">
        <h4 class="heading short-border short-border__left-align">
    ...
    <div class="row mb-4">
      <div class="col">
        ...
        <div id="generatedDataCollecting" class="ol">
          ...
          <div class="li">5.6. адрес и город.</div>
          <div class="li">
            5.7. Также на сайте происходит сбор и обработка обезличенных данных
          ...
          <div class="li">
            ...
            если соблюдаются запреты и условия, предусмотренные ст. 10.1 Закона
      ...
      <div class="col">
        ...
        <div class="ol">
          ...
          <div id="generatedLegalProcessingData">
            ...
            <div class="li">– уставные документы Оператора;</div>
            <div class="li">
        ...
        <div class="ol">
          ...
          <div class="li">
            ...
            <span
              ...
              class="link mark"
              >https://mindclickon.com/privacy</span
            >.
          </div>
        </div>
      </div>
